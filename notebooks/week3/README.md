...
This folder contains the materials for Week 3 of the PaperAlchemy project, where we implement the **keyword search foundation** that professional RAG systems rely on using OpenSearch and BM25 scoring.
...
| **Health Check** | http://localhost:8000/api/v1/health | Detailed service health |
| **Search (GET)** | http://localhost:8000/api/v1/search?q=machine+learning | Simple search |
| **Search (POST)** | http://localhost:8000/api/v1/search | Advanced search |
| **OpenSearch** | http://localhost:9201 | OpenSearch API |
| **OpenSearch Dashboards** | http://localhost:5602 | Search UI |
| **Airflow** | http://localhost:8080 | Workflow management |

## Expected Outcomes

By completing Week 3, you will have:

1. **Working Search System**: Fully functional OpenSearch BM25 search with indexed papers
...
- Two-Letter Queries: AI, ML, NN, CV queries working
- Pipeline Integration: Papers indexed from PostgreSQL to OpenSearch
